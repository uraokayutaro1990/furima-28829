...
ActiveRecord::Schema.define(version: 2020_09_16_061614) do
  ...
  create_table "donations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
